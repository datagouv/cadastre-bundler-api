...
app.get('/feuilles/:codeFeuille/edigeo-cc', async (req, res) => {
  try {
...
app.get('/communes/:codeCommune/edigeo-cc', async (req, res) => {
  try {
...
app.get('/communes/:codeCommune/:format', async (req, res) => {
  try {
