...
function departementPath(basePath, codeDep) {
  return join(basePath, 'etalab-cadastre', 'latest', 'departements', codeDep)
}
...
module.exports = {getLayerPath, departementPath, communePath, listDepartements, listLayerFilesByDepartement, departementLayerPath}
